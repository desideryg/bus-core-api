/**
 * Charter / special-hire whole-bus sale: request, operator quote, accept, driver check-in, manifest.
 *
 * <p>Package root of the {@code charter} module, and its <b>only</b> published surface: a type another
 ...
 */
package tz.co.otapp.buscore.charter;
