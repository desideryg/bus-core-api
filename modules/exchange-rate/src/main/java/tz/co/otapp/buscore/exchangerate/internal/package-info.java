/**
 * Module-private internals of {@code exchange-rate}. Nothing outside {@code tz.co.otapp.buscore.exchangerate} may import from
 ...
 */
package tz.co.otapp.buscore.exchangerate.internal;
