/**
 * Multi-currency FX rates + a Money currency-conversion port. No HTTP surface of its own.
 *
 * <p>Package root of the {@code exchange-rate} module, and its <b>only</b> published surface: a type another
 ...
 */
package tz.co.otapp.buscore.exchangerate;
