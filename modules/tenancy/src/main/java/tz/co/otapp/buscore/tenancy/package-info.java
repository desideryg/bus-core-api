/**
 * The tenant hierarchy Company -> Brand -> Operator -> Branch, and each tier's setup and lifecycle.
 *
 * <p>Package root of the {@code tenancy} module, and its <b>only</b> published surface: a type another
 ...
 */
package tz.co.otapp.buscore.tenancy;
