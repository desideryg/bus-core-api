/**
 * Selling-authority boundary: which agents may sell what, for whom, under what limits. Fails closed.
 *
 * <p>Package root of the {@code agent} module, and its <b>only</b> published surface: a type another
 ...
 */
package tz.co.otapp.buscore.agent;
