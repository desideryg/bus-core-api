/**
 * Stations, routes, and ordered route stops — where a bus can go and where passengers board or alight.
 *
 * <p>Package root of the {@code network} module, and its <b>only</b> published surface: a type another
 ...
 */
package tz.co.otapp.buscore.network;
