/**
 * Module-private internals of {@code fiscal-adapter}. Nothing outside {@code tz.co.otapp.buscore.fiscaladapter} may import from
 ...
 */
package tz.co.otapp.buscore.fiscaladapter.internal;
