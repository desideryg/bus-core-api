/**
 * Generic revenue-authority fiscal receipting behind an inward-pointing port; the concrete authority lives only in an adapter selected by config.
 *
 * <p>Package root of the {@code fiscal-adapter} module, and its <b>only</b> published surface: a type another
 ...
 */
package tz.co.otapp.buscore.fiscaladapter;
