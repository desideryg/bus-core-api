/**
 * Module-private internals of {@code documents}. Nothing outside {@code tz.co.otapp.buscore.documents} may import from
 ...
 */
package tz.co.otapp.buscore.documents.internal;
