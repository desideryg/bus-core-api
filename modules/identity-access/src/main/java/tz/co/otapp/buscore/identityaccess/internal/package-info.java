/**
 * Module-private internals of {@code identity-access}. Nothing outside {@code tz.co.otapp.buscore.identityaccess} may import from
 ...
 */
package tz.co.otapp.buscore.identityaccess.internal;
