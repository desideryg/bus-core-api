/**
 * Cross-cutting kernel (tz.co.otapp.buscore.shared): CRUD foundation, money, messaging/outbox, translation, query. Depends on no domain module.
 *
 * <p>Package root of the {@code shared} module, and its <b>only</b> published surface: a type another
