/**
 * Fare calculation and snapshotting; the fare-parity origin. No HTTP surface of its own.
 *
 * <p>Package root of the {@code fare} module, and its <b>only</b> published surface: a type another
 ...
 */
package tz.co.otapp.buscore.fare;
