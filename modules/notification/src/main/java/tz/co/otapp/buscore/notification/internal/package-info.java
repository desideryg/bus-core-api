/**
 * Module-private internals of {@code notification}. Nothing outside {@code tz.co.otapp.buscore.notification} may import from
 ...
 */
package tz.co.otapp.buscore.notification.internal;
