/**
 * Module-private internals of {@code uts-adapter}. Nothing outside {@code tz.co.otapp.buscore.utsadapter} may import from
 ...
 */
package tz.co.otapp.buscore.utsadapter.internal;
