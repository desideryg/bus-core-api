/**
 * Object/blob store behind a MinIO/S3 provider port: files, versions, directories, galleries, template blobs.
 *
 * <p>Package root of the {@code storage} module, and its <b>only</b> published surface: a type another
 ...
 */
package tz.co.otapp.buscore.storage;
