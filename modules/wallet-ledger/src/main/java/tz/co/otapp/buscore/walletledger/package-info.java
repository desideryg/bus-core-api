/**
 * Agent wallet accounts, immutable ledger entries, commission posting; balance is derived, never stored.
 *
 * <p>Package root of the {@code wallet-ledger} module, and its <b>only</b> published surface: a type another
 ...
 */
package tz.co.otapp.buscore.walletledger;
