/**
 * Module-private internals of {@code wallet-ledger}. Nothing outside {@code tz.co.otapp.buscore.walletledger} may import from
 ...
 */
package tz.co.otapp.buscore.walletledger.internal;
