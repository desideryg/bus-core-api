/**
 * Module-private internals of {@code seat-inventory}. Nothing outside {@code tz.co.otapp.buscore.seatinventory} may import from
 ...
 */
package tz.co.otapp.buscore.seatinventory.internal;
