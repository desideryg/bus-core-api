/**
 * Seat availability, distributed locks, and holds; the durable partial-unique double-sell arbiter.
 *
 * <p>Package root of the {@code seat-inventory} module, and its <b>only</b> published surface: a type another
 ...
 */
package tz.co.otapp.buscore.seatinventory;
