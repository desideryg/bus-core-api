/**
 * Scheduled trips: schedule lifecycle, assignment, readiness, and the seat-materialisation trigger.
 *
 * <p>Package root of the {@code scheduling} module, and its <b>only</b> published surface: a type another
 ...
 */
package tz.co.otapp.buscore.scheduling;
