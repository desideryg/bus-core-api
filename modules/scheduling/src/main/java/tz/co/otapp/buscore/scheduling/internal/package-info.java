/**
 * Module-private internals of {@code scheduling}. Nothing outside {@code tz.co.otapp.buscore.scheduling} may import from
 ...
 */
package tz.co.otapp.buscore.scheduling.internal;
