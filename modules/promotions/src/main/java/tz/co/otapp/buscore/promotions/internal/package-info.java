/**
 * Module-private internals of {@code promotions}. Nothing outside {@code tz.co.otapp.buscore.promotions} may import from
 ...
 */
package tz.co.otapp.buscore.promotions.internal;
