/**
 * Shared DTOs, the error catalog, and the RFC 9457 problem envelope. Code-first.
 *
 * <p>Package root of the {@code api-contracts} module, and its <b>only</b> published surface: a type another
