/**
 * Module-private internals of {@code api-contracts}. Nothing outside {@code tz.co.otapp.buscore.apicontracts} may import from
 ...
 */
package tz.co.otapp.buscore.apicontracts.internal;
