/**
 * Internal payment/settlement state and the payment-gateway port the gateway adapter implements.
 *
 * <p>Package root of the {@code payment-settlement} module, and its <b>only</b> published surface: a type another
 ...
 */
package tz.co.otapp.buscore.paymentsettlement;
