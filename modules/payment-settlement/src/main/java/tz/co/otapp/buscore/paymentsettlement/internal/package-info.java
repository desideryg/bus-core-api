/**
 * Module-private internals of {@code payment-settlement}. Nothing outside {@code tz.co.otapp.buscore.paymentsettlement} may import from
 ...
 */
package tz.co.otapp.buscore.paymentsettlement.internal;
