/**
 * Payment-gateway anti-corruption layer implementing payment-settlement's inbound port; signed callbacks.
 *
 * <p>Package root of the {@code payment-gateway-adapter} module, and its <b>only</b> published surface: a type another
 ...
 */
package tz.co.otapp.buscore.paymentgatewayadapter;
