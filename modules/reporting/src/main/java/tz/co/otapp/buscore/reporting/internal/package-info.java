/**
 * Module-private internals of {@code reporting}. Nothing outside {@code tz.co.otapp.buscore.reporting} may import from
 ...
 */
package tz.co.otapp.buscore.reporting.internal;
