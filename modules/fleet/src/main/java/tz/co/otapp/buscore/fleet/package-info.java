/**
 * The operator's physical assets: the seatable vehicle and its seat layout (setup), and the asset lifecycle around it (suppliers, inventory, procurement, maintenance, compliance).
 *
 * <p>Package root of the {@code fleet} module, and its <b>only</b> published surface: a type another
 ...
 */
package tz.co.otapp.buscore.fleet;
