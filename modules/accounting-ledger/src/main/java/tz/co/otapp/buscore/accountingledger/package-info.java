/**
 * Double-entry general ledger: chart of accounts, balanced journals, append-only posted ledger, derived balances.
 *
 * <p>Package root of the {@code accounting-ledger} module, and its <b>only</b> published surface: a type another
 ...
 */
package tz.co.otapp.buscore.accountingledger;
