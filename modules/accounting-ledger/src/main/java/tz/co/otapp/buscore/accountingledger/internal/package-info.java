/**
 * Module-private internals of {@code accounting-ledger}. Nothing outside {@code tz.co.otapp.buscore.accountingledger} may import from
 ...
 */
package tz.co.otapp.buscore.accountingledger.internal;
